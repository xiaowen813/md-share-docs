  ...
  return [30, 76, 185].map((idx) => {
    ...
    return {
      ...
      lastBlock: blocks.length ? {
        top: blocks[blocks.length - 1].offsetTop,
        h: blocks[blocks.length - 1].offsetHeight,
        lines: blocks[blocks.length - 1].querySelectorAll('.code-line').length,
      } : null,
    }
  })
})
